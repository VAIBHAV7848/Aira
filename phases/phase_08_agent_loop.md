...
## Goal
The core execution loop that ties state machine, tools, planner, security, and memory together.

## Prerequisites
- Phases 2–7 all passing tests

## Files to Create

### `aira/agent/completion.py`
...
class AgentLoop:
    ...
    async def run(self, task_description: str, task_id: str | None = None) -> dict:
        ...
        final = {
            ...
            "cost": self.cost_ctrl.get_summary(),
        }
...
```powershell
pytest aira/tests/test_agent_loop.py -v
```

## Done When
- [ ] `aira/agent/completion.py` created
- [ ] `aira/agent/loop.py` created
- [ ] `aira/tests/test_agent_loop.py` created
- [ ] All tests pass
