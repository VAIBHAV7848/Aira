# Phase 9 — Persona Layer

## Goal
Waifu personality wrapper with strict content boundaries. ZERO execution authority.

## Prerequisites
- Phase 6 (local LLM) passing

## File to Create

### `aira/persona/persona_manager.py`
...
class PersonaManager:
    ...
    async def wrap_response(self, raw_response: str, local_llm) -> str:
        ...
        try:
            ...
            logger.warning(f"Persona wrapping failed, using raw response: {e}")
            return raw_response
...
```powershell
pytest aira/tests/test_persona.py -v
```

## Done When
- [ ] `aira/persona/persona_manager.py` created
- [ ] `aira/tests/test_persona.py` created
- [ ] All tests pass
- [ ] Persona module does NOT import tools, security, or agent modules

## Next Phase
→ `phase_10_telegram.md`
